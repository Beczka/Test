...
describe.each([
    ...
    test("price matches requirements", () => {
        const withoutSession = calculatePrice(["Photography"], year);  //1700
...
describe.each([
    ...
    test("price matches requirements", () => {
        const withoutPhotography = calculatePrice(["VideoRecording"], year);    //1700
        const withPhotography = calculatePrice(["VideoRecording", "Photography"], year); //2200
